...
public class Authorities {
    ...
    public static final String ROLE_INDEX = "hasPermission(null, 'ROLE_INDEX')";
    public static final String ROLE_CREATE = "hasPermission(null, 'ROLE_CREATE')";
    public static final String ROLE_RETRIEVE = "hasPermission(null, 'ROLE_RETRIEVE')";
    public static final String ROLE_UPDATE = "hasPermission(null, 'ROLE_UPDATE')";
    public static final String ROLE_DELETE = "hasPermission(null, 'ROLE_DELETE')";
